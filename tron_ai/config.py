...
DEFAULT_ROOT_LEVEL = os.getenv("TRON_LOG_LEVEL_ROOT", "INFO")
DEFAULT_APP_LEVEL = os.getenv("TRON_LOG_LEVEL_tron_ai", "INFO")
DEFAULT_THIRD_PARTY_LEVEL = os.getenv("TRON_LOG_LEVEL_THIRD_PARTY", "INFO")
DEFAULT_UTILITY_LEVEL = os.getenv("TRON_LOG_LEVEL_UTILITY", "INFO")

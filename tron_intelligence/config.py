...
# Example: TRON_LOG_LEVEL_tron_intelligence=DEBUG
# Example: TRON_LOG_LEVEL_ROOT=INFO (for the root logger)
# Example: TRON_LOG_LEVEL_tron_intelligence_MODULES_MCP_MULTI_MCP_CLIENT=DEBUG
...
DEFAULT_APP_LEVEL = os.getenv("TRON_LOG_LEVEL_TRON_INTELLIGENCE", "INFO")
...
LOGGING_CONFIG = {
    ...
    "loggers": {
        ...
        "tron_intelligence.cli": {
            "handlers": ["rich"],
            "level": "INFO",
            "propagate": False,
        },
        "tron_intelligence.config": {
            "handlers": ["rich"],
            "level": DEFAULT_APP_LEVEL,
            "propagate": False,
        },
        "tron_intelligence.utils.LLMClient": {
            "handlers": ["rich"],
            "level": "DEBUG",
            "propagate": False,
        },
        "tron_intelligence.utils.connection_manager": {
            "handlers": ["rich"],
            "level": DEFAULT_UTILITY_LEVEL,
            "propagate": False,
        },
        "tron_intelligence.utils.async_process_monitor": {
            "handlers": ["rich"],
            "level": DEFAULT_UTILITY_LEVEL,
            "propagate": False,
        },
        "tron_intelligence.utils.file_manager": {
            "handlers": ["rich"],
            "level": DEFAULT_UTILITY_LEVEL,
            "propagate": False,
        },
        "tron_intelligence.utils.async_file_io": {
            "handlers": ["rich"],
            "level": DEFAULT_UTILITY_LEVEL,
            "propagate": False,
        },
        "tron_intelligence.utils.async_chromadb": {
            "handlers": ["rich"],
            "level": DEFAULT_UTILITY_LEVEL,
            "propagate": False,
        },
...
logger = logging.getLogger("tron_intelligence.config")
